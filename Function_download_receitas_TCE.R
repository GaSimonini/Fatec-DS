  ...
  download_receitas <- function(anos_f, lista_municipios_f) {
    ...
    # os parâmetros são passados à função, porem caso queira executar o codigo direto, os parametros pode ser substituidos 
    # anos_f             <- "2025"
    ...
    #Rename nas colunas, apenas para terem nomes mais compreensíveis
